...
<figcaption><strong>Image of the video and each of the RGB channels.</strong> A column of smoke is highlighted in green and areas with flames in red. Empirically, we observe that the red channel seems to preserve the information concerning the luminous part of the flames and, simultaneously, the smoke zones seem to be less visible.} </figcaption>
</p>

<p align="center">
<img src="assets/temporal_consitency.png" width="240px"/>
<figcaption><strong>Performance metrics on the test set.</strong> </figcaption>
</p>
